...
<main bind:this={workRef} class="work-container">
	<header class="work-header">
        ...
        <p class="sub-headline">
			Client work, research collaborations, and experiments. Check out our open-source tools in the Tools tab.
		</p>
	</header>
                    ...
                    <div class="project-main">
                        ...
                        <div class="project-content">
                            ...
                            <div class="tool-actions">
                                {#if tool.repository}
                                    <a href={tool.repository} target="_blank" rel="noopener noreferrer" class="view-project">GitHub</a>
                                {/if}
                                {#if tool.downloadUrl}
                                    <a href={tool.downloadUrl} target="_blank" rel="noopener noreferrer" class="view-project">Download</a>
                                {/if}
                                {#if tool.liveUrl}
                                     <a href={tool.liveUrl} target="_blank" rel="noopener noreferrer" class="view-project">Try It</a>
                                {/if}
                            </div>
                        </div>
                    </div>
